...
<body>
	...
	<header class="header">
		<div class="container-title">
			<h1 class="page-title">List of Programs Filters</h1>
		</div>
	</header>
			...
			<div class="container-fluid">
				<div class="row-fluid">
					<div class="btn-toolbar">
						<a class="btn btn-success" href="<c:url value='#' />">Add New
							Program-Filter</a>
					</div>
				</div>
			</div>
	...
	<table class="table table-striped table-bordered" cellspacing="0"
		...
		<c:forEach var="programFilters" items="${programsFilters}">
			<tr>
				...
				<td><a
					href="<c:url value='/administrator/delete-${programFilters.id}-program-filter' />">delete</a></td>
			</tr>
		</c:forEach>
	</table>
</body>
