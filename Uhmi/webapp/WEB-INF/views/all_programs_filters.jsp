...
<body>
			...
			<div class="container-fluid">
				<div class="row-fluid">
					<div class="btn-toolbar">
						<a class="btn btn-success"  href="<c:url value='#' />">Add New Program-Filter</a>						
					</div>
				</div>			
			</div>
		</div>
	...
	<table class="table table-striped table-bordered" cellspacing="0" width="100%">
		<tr>
			<td>PROGRAM NAME</td><td>COMPANY NAME</td><td>FILTER NAME</td><td>DELETE</td>
		</tr>
		...
		<tr>		
			...
			<td><a href="<c:url value='/delete-${programFilters.id}-program-filter' />">delete</a></td>	
		</tr>
		</c:forEach>
	</table>
</body>
