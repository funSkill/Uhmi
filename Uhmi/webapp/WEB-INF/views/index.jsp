...
<body>
		...
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<c:url value='/' />">Home</a> <a
					class="navbar-brand" href="<c:url value='/administrator' />">Admin
					Panel</a>
			</div>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="btn-bar col-lg-12">
				<a class="btn_filter  btn btn-info"
					href="<c:url value='/programs-filter' />">обрати програму за
					допомогою фільтру</a>
			</div>
		</div>
		<!-- /.row -->
	...
	<div class="companies-container">
		<c:forEach var="company" items="${companies}">
			<a class="btn btn-default btn-lg btn-company"
				href="<c:url value='/${company.id}' />">${company.name}</a>
		</c:forEach>
	</div>
</body>
</html>