...
<body>
			...
			<div class="container-fluid">
				<div class="row-fluid">
					<div class="btn-toolbar">
						<a class="btn btn-success"  href="<c:url value='/new-type-of-clients' />">Add New Type of clients</a>						
					</div>
				</div>			
			</div>
		</div>
	...
	<table class="table table-striped table-bordered" cellspacing="0" width="100%">
		<tr>
			<td>TIPE OF CLIENTS</td><td>ID</td><td>DELETE</td>
		</tr>
		<c:forEach var="typeOfClients" items="${typesOfClients}">
		<tr>
			<td>${typeOfClients.name}</td>			
			<td>${typeOfClients.id}</td>
			<td><a href="<c:url value='/delete-${typeOfClients.id}-types-of-clients' />">delete</a></td>
		</tr>
		</c:forEach>
	</table>
	<br/>
